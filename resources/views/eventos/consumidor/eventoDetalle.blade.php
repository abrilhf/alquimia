...
@section('main')
    <section class="detaildonacion">
        <div class="container">
            <h1 class="text-center">Detalle del evento {{ $evento->titulo }}</h1>
        ...
        <div class="container comentariosEventos">
            <h4 class="fs-3">¿Qué opinas?</h4>
            <form action="{{ route('eventos.consumidor.eventoDetalle', ['id' => $evento->eventos_id]) }}" method="POST">
                @csrf
                <div class="d-flex">
            ...
            <h5 class="fs-3 parrafo-con-linea-arriba"><span class="textoBlanco">Comentarios:</span></h5>
        ...
        <div class="d-flex justify-content-end m-1">
            <a class="btn costume-btn-volver m-5" href="{{ route('eventos.consumidor.eventos') }}">Volver</a>
        </div>
    </section>
