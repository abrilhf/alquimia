                    ...
                    <ul class="navbar-nav justify-content-center">
                        ...
                        @auth()
                            @if (auth()->user()->roles_id == 1)
                                <li class="nav-item">
                                    <a href="{{ route('admin.index') }}" class="text-decoration-none nav-link">Volver a mi perfil
                                        administrador</a>
                                </li>
                                <li class="nav-item">
                            ...
                            @elseif(auth()->user()->roles_id == 2)
                                <li class="nav-item">
                                    <a href="{{ route('consumidor.index') }}" class="btn nav-link">Volver a mi perfil
                                        consumidor</a>
                                </li>
                                <li class="nav-item">
                                    <form action="{{ route('auth.logout') }}" method="post">
                            ...
                            @elseif(auth()->user()->roles_id == 3)
                                <li class="nav-item">
                                    <a href="{{ route('donador.index') }}" class="btn nav-link">Volver a mi perfil donante</a>
                                </li>
                                <li class="nav-item">
                                    <form action="{{ route('auth.logout') }}" method="post">
                                        @csrf
